...
drawModal = function(){
	...
	with(obj_control){
		if(level_kitten_saved)
			draw_sprite_ext(spr_player_kitten, 0, other.x-102, other.y-14, 2, 2, 0, c_white, 1);
		else
			draw_sprite_ext(spr_player_kitten, 0, other.x-102, other.y-14, 2, 2, 0, c_black, 1);
		
		if(level_puppy_saved)
			draw_sprite_ext(spr_player_puppy, 0, other.x, other.y-31, 2, 2, 0, c_white, 1);
		else
			draw_sprite_ext(spr_player_puppy, 0, other.x, other.y-31, 2, 2, 0, c_black, 1);
		
		if(level_panda_saved)
			draw_sprite_ext(spr_player_baby_panda, 0, other.x+96, other.y-14, 2, 2, 0, c_white, 1);
		else
			draw_sprite_ext(spr_player_baby_panda, 0, other.x+96, other.y-14, 2, 2, 0, c_black, 1);
	}
}
